...
#define LAYOUTFILE <examples/GridLayoutCtrlExample/GridLayoutCtrlExample.lay>
#include <CtrlCore/lay.h>

class GridLayoutCtrlExample : public WithGridLayout_exampleLayout<TopWindow> {
public:
